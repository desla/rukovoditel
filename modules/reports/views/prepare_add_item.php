...
<div class="modal-body">
  ...
  <div class="form-group" >
    ...
    <div class="col-md-9">	
  	  <?php echo select_tag('parent_item_id',items::get_choices_by_entity($entity_info['id'],$entity_info['parent_id'],$report_info['parent_id']),'',array('class'=>'form-control chosen-select required')) ?>
    </div>			
  </div> 
