...
<div class="tab-content">
  <div class="tab-pane fade active in" id="general_info">
    ...
    <div class="form-group" id="is-heading-container">
    	<label class="col-md-3 control-label" for="is_heading"><?php echo '<i class="fa fa-info-circle" data-toggle="tooltip" data-placement="right" title="' . addslashes(TEXT_IS_HEADING_INFO). '"></i> ' . TEXT_IS_HEADING ?></label>
      <div class="col-md-9">	
        ...
        <?php echo ''//echo tooltip_text(TEXT_IS_HEADING_INFO); ?>
      </div>			
    </div>
...
function check_is_heading_option()
{
   ...
   if($.inArray(selected_type,["fieldtype_input_numeric_comments","fieldtype_input_url","fieldtype_attachments","fieldtype_input_file","fieldtype_image","fieldtype_textarea_wysiwyg","fieldtype_formula","fieldtype_related_records"])==-1)
   {
