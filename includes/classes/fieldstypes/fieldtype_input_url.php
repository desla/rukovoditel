...
class fieldtype_input_url
{
  ...
  {
    $cfg = array();
    $cfg[] = array('title'=>TEXT_URL_PREVIEW_TEXT, 'name'=>'preview_text','type'=>'input','tooltip'=>TEXT_URL_PREVIEW_TEXT_TIP,'params'=>array('class'=>'form-control input-medium'));
    $cfg[] = array('title'=>TEXT_URL_PREFIX, 'name'=>'prefix','type'=>'input','tooltip'=>TEXT_URL_PREFIX_TIP,'params'=>array('class'=>'form-control input-small'));        
