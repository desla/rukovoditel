...
/* class constructor */
    function split_page($query,$listing_container,$count_sql_query = '') {
      global $_GET, $_POST;
      ...
      $this->number_of_rows_per_page = CFG_APP_ROWS_PER_PAGE;
...
// previous button - not displayed on first page
      ...
      {
        $html .= '<li><a href="#" onClick="load_items_listing(\'' . $this->listing_container . '\',' . ($this->current_page_number - 1) . '); return false;"  title=" ' . PREVNEXT_TITLE_PREVIOUS_PAGE . ' ">&laquo;</a></li>';
      }
      else
      {
        $html .= '<li class="active"><a href="#" onClick="return false">&laquo;</a></li>';
      }
...
// next button
      ...
      { 
        $html .= '<li><a href="#"  onClick="load_items_listing(\'' . $this->listing_container . '\',' . ($this->current_page_number + 1) . '); return false;" title=" ' . PREVNEXT_TITLE_NEXT_PAGE . ' ">&raquo;</a></li>';
      }
      else
      {
        $html .= '<li class="active"><a href="#"  onClick="return false">&raquo;</a></li>';
      }
