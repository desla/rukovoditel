...
define('TEXT_BUTTON_LOGIN','Логин');
...
define('TEXT_ERROR_USEREMAL_EMPTY','E-amil пользователя не может быт пустым.');
...
define('TEXT_MENU_LOGIN','Логин');
define('TEXT_MENU_LDAP_LOGIN','LDAP Логин');
...
define('TEXT_MENU_EMAIL_OPTIONS','Параметры электронной почты');
define('TEXT_MENU_LDAP','LDAP');
define('TEXT_MENU_LOGIN_PAGE','Страницы входа');
...
define('TEXT_LDAP_EMAIL_ATTRIBUTE','Email-атрибут LDAP');
define('TEXT_LDAP_EMAIL_ATTRIBUTE_NOTES','Задайте имя атрибута email пользователя (если он существует) для автоматического присвоения email-адресов новым пользователям. Если это поле оставить пустым, то email-адреса пользователей, которые впервые вошли на конференцию, также будут пустыми.');
...
define('TEXT_EMAIL_SEND_FROM_SINGLE','Отправлять все письма с одного адреса электронной почты ');
...
define('TEXT_EMAIL_SMTP_LOGIN','SMTP логин');
...
define('TEXT_MENU_USER_REGISTRATION_EMAIL','Регистрация нового пользователя');
...
define('TEXT_DISPLAY_NUMBER_OF_ITEMS', 'Отображено <strong>%d</strong> - <strong>%d</strong> (всего <strong>%d</strong> элементов)');
...
define('TEXT_MY_ACCOUNT','Мой аккаунт');
...
define('TEXT_FORMULA_TIP','Используйте [ID поля] для установки значения поля в формуле. Пример: ([36]+[54])/2 где 36 и 54 - идентификаторы числовых полей.');
...
define('TEXT_CHOICES_PARENT_INFO','Выберете родительское значение');
...
define('TEXT_ENTITY_ACCESS_INFO','На этой странице вы можете настроить доступ к каждой группе пользователей.<br>Для открытия доступа выберите опцию "Просмотр" и настройте доступ для Создания/Редактирования/Удаления<br>Опция "Просматривать только назначенные" разрешает просмотривать только те элементы, на которые назначены пользователи.');
...
define('TEXT_LOGIN_PAGE_BACKGROUND_INFO','Изображения растягивается на всю ширину страницы. Рекомендуется использовать изображение 1920х1200');
...
define('TEXT_HEADING_MY_ACCOUNT','Мой аккаунт');
...
define('TEXT_DISPLAY_USERS_AS_TOOLTIP','Используйте флажки для возможности выбора нескольких пользователей');
define('TEXT_USERS_LIST','Список пользователей');
define('TEXT_FILTER_BY_DAYS','Фильтр по дням');
define('TEXT_FILTER_BY_DAYS_TOOLTIP','Вы можете использовать "+1" что означает "текущая дата+1". Значение может быть "-1". Так же вы можете указать несколько дней, например "+1&2&3".');
...
define('TEXT_SKIN_TOOLTIP','По умолчанию, если внешний вид не задан, и пользователи могут изменять внешний вид.<br>Выбранный внешний вид будет установлен для всех пользователей и возможность изменять внешний вид будет скрыта.');
...
define('TEXT_SELECT_FIELD_TO_EXPORT','Выберете поля для экспорта');
...
define('TEXT_IMPORT_DATA_INFO','Вы можете импортировать данные из таблицы в формате Exel.');
...
define('TEXT_IMPORT_BIND_FIELDS','Свяжите поля  со столбцами таблицы ниже и начните импорт. Колонки, которые не связанные с полем, не будут импортироваться.');
...
define('TEXT_SELECT_SOME_VALUES','Выберете значение');
...
define('TEXT_USER_PUBLIC_PROFILE_NO_FIELDS','Нету доступных полей для отображения в профиле.');
define('TEXT_HEADING_EXTENSION','Дополнение');
define('TEXT_EXTENSION_IFNO','Дополнение расширит ваше приложение добавив такие возможности как: диаграмма ганта, календарь, графический отчет и многое другое.');
...
define('TEXT_ERROR_NO_HEADING_FIELD','Не найдено поля установленного как Заголовок. Пожалуйста установите поле как Заголовок на странице настройки полей.');
...
define('TEXT_MENU_ICON_TITLE_TOOLTIP','Введите название иконки из библиотеки Font Awesome, fнапример: fa-bell. <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank">Просмотреть список доступных иконок</a>');
...
define('TEXT_URL_PREFIX_TIP','Если в ссылке отсутствует префикс то префикс "http://" будет автоматически добавлен к ссылке. Если вы хотите использовать другой префикс по умолчанию (например "sip:"), введите его в этом поле.');
...
define('TEXT_FIELDTYPE_IMAGE_TOOLTIP','Позволяет загрузить одино изображения');
...
define('TEXT_NOTIFY_WHEN_CHANGED_TIP','Назначенные пользователи будут уведомлены, когда значение изменилось.');
